...
class Supervisor(nn.Module):
    """
    Supervisor Network: Generate next sequence using the previous sequence.
    ...
    Returns:
      - S: Generated sequence based on the latent representations generated
        by the generator
    """
    ...
    def forward(self, H, parameters):
        ...
        S, _ = self.rnn_stack(packed_input, rnn_init_hidden)
        return S
